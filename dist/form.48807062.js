...
})({"3upNP":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "4a236f9275d0a351";
module.bundle.HMR_BUNDLE_ID = "ae0e73fb48807062";
"use strict";
...
},{}],"6Qgc2":[function(require,module,exports) {
...
document.getElementById("create").onclick = function createDrink() {
    ...
    } else createdDrinks.push(selectAlkoForm.value);
    if (selectNonAlkoForm.value == "") {
        document.getElementById("nonalko-error").innerHTML += "Oops, something went wrong! <br> Please fill in this field";
        errorsArr.push(document.getElementById("nonalko-error").innerHTML);
    } else createdDrinks.push(selectNonAlkoForm.value);
    if (extraIngrForm.value == "") {
        document.getElementById("extra-error").innerHTML += "Oops, something went wrong! <br> Please fill in this field";
        errorsArr.push(document.getElementById("extra-error").innerHTML);
    } else createdDrinks.push(extraIngrForm.value);
    if (instructionsForm.value == "") {
        document.getElementById("instructions-error").innerHTML += "Oops, something went wrong! <br> Please fill in this field";
...
},{}]},["3upNP","6Qgc2"], "6Qgc2", "parcelRequire3cc9")

//# sourceMappingURL=form.48807062.js.map
