...
let $9f189f663e39dc5f$var$parent = document.getElementById("content");
$9f189f663e39dc5f$var$parent.innerHTML = "";
let $9f189f663e39dc5f$var$detailsDrink = document.getElementById("drinkContainer");
$9f189f663e39dc5f$var$detailsDrink.innerHTML = "";
        ...
        for (let item of search.drinks){
            ...
            list.onclick = function renderDrink() {
                fetch("https://www.thecocktaildb.com/api/json/v1/1/search.php?s=" + `${title.innerHTML}`).then((response)=>response.json()
                    ...
                    $9f189f663e39dc5f$var$detailsDrink.append(drinkImgContainer);
                    ...
                    $9f189f663e39dc5f$var$detailsDrink.append(drinkDetailsContainer);
...
//# sourceMappingURL=index.26c54bfd.js.map
